...
const icons: { [key: string]: string } = {
  ...
  sapper: "https://sapper.svelte.dev/sapper-logo-outline.svg",
  vuepress: "https://vuepress.vuejs.org/images/hero.png",
...
const skillWebsites: LooseObject = {
...
const initialSkillState: LooseObject = {}

const skillsArray: string[][] = Object.keys(categorizedSkills).map(
  key => categorizedSkills[key].skills
)
const skills = skillsArray.reduce((acc, val) => acc.concat(val), []).sort()
